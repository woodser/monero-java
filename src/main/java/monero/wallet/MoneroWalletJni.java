...
public abstract class MoneroWalletJni extends MoneroWalletDefault {
  ...
  protected abstract void setDaemonConnectionJni(String uri, String username, String password);
  
  protected abstract void setProxyJni(String uri);
  ...
  //protected static String[] getSeedLanguagesJni();
