...
import monero.common.MoneroRpcConnectionManager;
import monero.common.MoneroRpcConnectionManagerListener;
 ...
 */
public class TestMoneroRpcConnectionManager {
  ...
  public void testMoneroRpcConnectionManager() throws InterruptedException {
    ...
    try {
      ...
      MoneroRpcConnectionManager connectionManager = new MoneroRpcConnectionManager()
  ...
  private class ConnectionChangeCollector implements MoneroRpcConnectionManagerListener {
