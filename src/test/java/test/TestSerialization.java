...
public class TestSerialization {
  ...
  public void testSimpleSerialization() {
    ...
    // serialize
    String json = JsonUtils.serialize(MoneroRpc.MAPPER, map1);
    
    // deserialize
    Map<String, Object> map2 = JsonUtils.deserialize(MoneroRpc.MAPPER, json, new TypeReference<Map<String, Object>>(){});
  ...
  public void testListSerialization() {
    ...
    Map<String, Object> deserialized = JsonUtils.deserialize(MoneroRpc.MAPPER, json, new TypeReference<Map<String, Object>>(){});
