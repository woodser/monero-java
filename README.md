...
A Java library for creating Monero applications using RPC and JNI bindings to [monero v0.17.2.3 'Oxygen Orion'](https://github.com/monero-project/monero/tree/v0.17.2.3).
...
`compile 'io.github.monero-ecosystem:monero-java:0.5.5'`
