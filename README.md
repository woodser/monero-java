...
A Java library for creating Monero applications using RPC and JNI bindings to [monero v0.18.2.2 'Flourine Fermie'](https://github.com/monero-project/monero/tree/v0.18.2.2).
...
`compile 'io.github.monero-ecosystem:monero-java:0.7.17'`
