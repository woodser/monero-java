...
A Java library for creating Monero applications using RPC or JNI bindings to [monero v0.18.5.1 'Fluorine Fermi'](https://github.com/monero-project/monero/tree/v0.18.5.1).
...
`compile 'io.github.woodser:monero-java:0.8.51'`
