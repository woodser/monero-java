...
A Java library for creating Monero applications using RPC and JNI bindings to [monero v0.17.2.0 'Oxygen Orion'](https://github.com/monero-project/monero/tree/v0.17.2.0).
