...
A Java library for creating Monero applications using RPC and JNI bindings to [monero v0.18.2.0 'Flourine Fermie'](https://github.com/monero-project/monero/tree/v0.18.2.0).
...
`compile 'io.github.monero-ecosystem:monero-java:0.7.13'`
...
12. [Build ./external/monero-cpp as a shared library](https://github.com/monero-ecosystem/monero-cpp#building-libmonero-cppdll-on-windows). Follow instructions for Windows.
